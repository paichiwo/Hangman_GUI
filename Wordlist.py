...
world_list = "adverb, animal, art, beverage, body, building, clothing, color, computer, continent, " \
            ...
            "angry, pizza, banana, chair, mountain, violin, necklace, actor, pan, gold, healthcare, aluminum, " \
            "rock, zebra, writer, beach, botany, firefighter, flower, engineer, university, chemistry, " \
            "cone, baseball, wrench, carrot, rainbow, world, green, calm, elephant, etching, lemonade, belly, " \
            ...
            "garden, physicist, shovel, car, pepper, cloudy, brown, fast, horse, woodcut, bone, house".split(", ")
